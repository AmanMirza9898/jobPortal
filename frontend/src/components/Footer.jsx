...
export const Footer = () => {
  ...
  return (
    <footer className="text-slate-600 dark:text-slate-400 font-sans pt-16 pb-8 border-t border-slate-200 dark:border-slate-800 bg-white dark:bg-neutral-950">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-16">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <p className="text-[14px]">
              <span className="font-bold text-slate-900 dark:text-slate-200">For Hiring:</span> From tech startups to Fortune 500 companies,
          ...
          <div className="lg:col-span-2">
            <h3 className="text-slate-900 dark:text-slate-200 font-bold text-lg mb-6">Candidates</h3>
          ...
          <div className="lg:col-span-3">
            <h3 className="text-slate-900 dark:text-slate-200 font-bold text-lg mb-6">Employers</h3>
            <ul className="space-y-3 text-[15px]">
          ...
          <div className="lg:col-span-2">
            <h3 className="text-slate-900 dark:text-slate-200 font-bold text-lg mb-6">Support</h3>
            <ul className="space-y-3 text-[15px]">
        ...
        {/* Contact & Socials */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 py-12 border-t border-slate-100 dark:border-slate-800">
          <div>
            <h3 className="text-slate-900 dark:text-slate-200 font-bold text-lg mb-6">Contact Us</h3>
          ...
          <div className="md:text-right">
            <h3 className="text-slate-900 dark:text-slate-200 font-bold text-lg mb-6 md:pr-2">Connect With Us</h3>
            <div className="flex md:justify-end gap-3 mb-6">
              {[Linkedin, Twitter, Instagram, Facebook].map((Icon, idx) => (
                <a key={idx} href="#" className="p-3 border border-slate-200 dark:border-slate-700 rounded-lg text-slate-600 dark:text-slate-400 hover:text-blue-600 hover:border-blue-600 transition-all">
                  <Icon size={20} />
                </a>
              ))}
            </div>
